            ...
            <div class="grid lg:grid-cols-2 items-center">
                ...
                <div class="flex flex-wrap items-center justify-start lg:justify-end gap-7 mt-5 lg:mt-0">
                    <button class="flex items-center">
                        <a href="#" class="bg-primary text-white rounded-full hover:shadow-lg hover:shadow-primary/30 focus:shadow-none focus:outline focus:outline-primary/40 transition-all duration-500 py-2 px-4">Liên hệ</a>
                    </button>
                    <a href="#" class="hover:text-primary transition-all duration-500">Chat</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="grid lg:grid-cols-2 grid-cols-1 gap-14 py-6">
            <div>
                ...
                <p class="text-gray-500/80 mt-5 w-4/5">Make your web application stand out with high-quality landing page</p>
            </div>
