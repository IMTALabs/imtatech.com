                ...
                <div class="flex flex-wrap items-center justify-start lg:justify-end gap-7 mt-5 lg:mt-0">
                    <button class="flex items-center">
                        <a href="https://www.facebook.com/imtatechcom/" target="_blank"
                           class="bg-primary text-white rounded-full hover:shadow-lg hover:shadow-primary/30 focus:shadow-none focus:outline focus:outline-primary/40 transition-all duration-500 py-2 px-4">
                            Đăng ký tư vấn
                        </a>
                    </button>
                </div>
        ...
        <div class="grid lg:grid-cols-2 grid-cols-1 gap-14 py-6">
            <div>
                ...
                <p class="text-gray-400 text-xs leading-6">
                    Tầng 4, Toà văn phòng số 565 Phạm Văn Đồng, Phường Cổ Nhuế 1, Quận Bắc Từ Liêm, Thành phố Hà Nội,
                    Việt Nam.<br>
                ...
                <div class="flex flex-col sm:flex-row gap-14 flex-wrap sm:flex-nowrap justify-between">
                    ...
                    <div>
                        <div class="flex flex-col gap-3">
                            ...
                            <div class="text-gray-500/80"><a href="{{ route('landing.about_us') }}">Về chúng tôi</a></div>
        ...
        <div class="grid sm:grid-cols-2 text-center sm:text-start gap-6 py-5">
            <div>
                <p class=" text-sm text-slate-500">
                    ...
                    © IMTA TECH. All rights reserved.
                    by <a href="{{ route('landing.home') }}"
                          class="text-gray-800 hover:text-primary transition-all font-medium">IMTA TECH</a>
                </p>
            </div>
            ...
            <div class="flex justify-center sm:justify-end gap-7">
                <div>
                    <a href="https://www.facebook.com/imtatechcom/" target="_blank">
                        <svg class="w-5 h-5 text-slate-500/90 hover:text-primary transition-all"
