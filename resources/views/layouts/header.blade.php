    ...
    <div class="container">
        <nav class="flex items-center">
                ...
                <ul class="navbar-nav flex gap-x-3 items-center justify-center">
                    ...
                    @if(false)
                        ...
                        <li class="nav-item">
                            ...
                            <div id="landingDropdownMenu" class="hidden opacity-0 mt-4 fc-dropdown-open:opacity-100 fc-dropdown-open:translate-y-0 translate-y-3 origin-center transition-all bg-white rounded-lg shadow-lg border p-2 w-72 fc-dropdown-open:grid gap-1.5">
                                <div class="nav-item">
            ...
            <div class="hidden lg:flex items-center ms-3">
                <a href="https://1.envato.market/prompt-tailwind" target="_blank" class="bg-primary text-white px-4 py-2 rounded inline-flex items-center text-sm">Liên hệ</a>
            </div>
