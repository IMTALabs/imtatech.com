...
@section('content')
        ...
        <div class="container">
            <div class="text-center lg:w-11/12 mx-auto">
                <div>
                    ...
                    <p class="sm:text-lg text-gray-500">Make your saas application stand out with high-quality landing
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-2 mt-12">
                        ...
                        <div class="flex items-center">
                            <input type="text" id="email-input" name="email-input" placeholder="Your Email"
                                   class="w-full rounded border-gray-300 focus:border-gray-400 focus:ring-0 bg-white py-2 px-4">
                        </div>
                        <a href="#"
                           class="py-2 px-4 rounded text-white bg-primary hover:shadow-lg hover:shadow-primary/50 focus:outline focus:outline-primary/50">Sign
                            Up</a>
                    </div>
    ...
    <div class="container">
        <div class="relative sm:-mt-80 -mt-64">
            <div class="hidden sm:block">
                <div
                    class="after:w-24 after:h-24 after:absolute after:-top-10 after:end-10 after:bg-[url('../images/pattern/dot5.svg')]"></div>
                <div
                    class="before:w-24 before:h-24 before:absolute before:-bottom-10 before:start-10 before:bg-[url('../images/pattern/dot2.svg')]"></div>
            </div>
            ...
            <div id="swiper_one" class="swiper border-[10px] border-white bg-white shadow-lg rounded-md w-5/6"
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        ...
                        <img src="assets/images/hero/saas1.png" alt="saas1" class="rounded-md">
                    </div>
                    ...
                    <div class="swiper-slide">
                        ...
                        <img src="assets/images/hero/saas2.png" alt="saas2" class="rounded-md">
                    </div>
                    ...
                    <div class="swiper-slide">
                        ...
                        <img src="assets/images/hero/saas3.png" alt="saas3" class="rounded-md">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="grid xl:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-5">
                        <div class="order-1">
                            <div class="flex flex-col gap-5">
                                <p class="flex items-center gap-3 text-base font-semibold"><i
    ...
    <section class="bg-gradient-to-r from-gray-100/70 to-gray-100/50 relative py-16 sm:py-24">
        ...
        <div class="py-5">
            <div class="container relative">
                ...
                <div class="text-center">
                    <span class="text-xs bg-primary/10 text-primary/90 rounded-full px-2 py-1">Plans</span>
                    <h1 class="text-3xl/tight font-medium mb-4 mt-5">Pricing</h1>
                            ...
                            <div class="border border-gray-300 bg-white rounded w-full h-full text-center p-5">
                                ...
                                <div>
                                    ...
                                    <div class="flex mt-20">
                                        <a href="#"
                                           class="bg-primary text-white w-full py-3 rounded-lg border border-transparent hover:shadow-lg hover:shadow-primary/30 hover:border hover:border-primary focus:outline focus:outline-primary/50 transition-all duration-300">Purchase
                                            Now</a>
                                    </div>
                                </div>
                            </div>
            ...
            <div data-fc-type="accordion" class="mt-14 lg:w-3/4 lg:mx-auto 2xl:w-2/3">
                ...
                <div class="border border-gray-300 rounded-lg">
                    <bu p-5tton
                        ...
                        <span
                            class="fa-solid fa-angle-down text-xl block transition-all fc-collapse-open:rotate-180"></span>
                    </bu>
                    <div class="w-full overflow-hidden transition-[height] duration-300">
                        <p class="text-slate-500 dark:text-gray-300 pt-3 p-5">
